...
const socialMediaLinks = {
  github: "https://github.com/marksamfd",
  linkedin: "https://www.linkedin.com/in/marksamfd/",
  gmail: "s-mark.kirelos@zewailcity.edu.eg",
...
const skillsSection = {
  title: "What I do",
  subTitle: "CRAZY DATA SCIENTIST WHO WANTS TO EXPLORE EVERY RESEARCH",
  skills: [
    emoji("⚡ Develop new models"),
    emoji("⚡ Understand the new reseatch"),
    emoji("⚡ Implement the best solution for the Problem")
  ],
...
const educationInfo = {
  ...
  schools: [
    ...
    {
      schoolName: "University of Science and Technology at Zewail City",
      logo: require("./assets/images/zewail logo.png"),
      subHeader: "Bachelor of Science in Computer Science",
      duration: "October 2022 - June 2026",
      desc: "Established by Dr. Ahmed Zewail. Took courses about Software Engineering, Deep Learning, ..."
  ...
  experience: [
    {
      ...
      desc: "Taught 6th-grade students foundational programming concepts, including an introduction to Python and the basics of AI and Machine Learning, fostering early interest and understanding in technology and innovation."
      // descBullets: [
      //   "Lorem ipsum dolor sit amet, consectetur adipiscing elit",
      //   "Lorem ipsum dolor sit amet, consectetur adipiscing elit"
      // ]
    ...
    {
      role: "IT Trainee",
      company: "Steigenberger Aldau Beach Hotel Hurghada",
      companylogo: require("./assets/images/stiegen.png"),
      date: "June 2023 – August 2023",
      desc: "Gained hands-on experience with hotel infrastructure by maintaining PCs, network devices, and cabling, ensuring smooth operation and connectivity across the facility."
    }
  ]
};
...
const podcastSection = {
  ...
  podcast: [
    "https://open.spotify.com/embed/show/3Mw8eB3BbXNyIzRruPxyHc?utm_source=generator"
  ],
  display: true // Set false to hide this section, defaults to true
};
...
const twitterDetails = {
  userName: "marksamfd", //Replace "twitter" with your twitter username without @
